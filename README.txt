...
# Intro #
Project Rocket is a web application based on alphavantage API.
Users could easily check for stocks prices of several frequently seen companies.
Also, several indicators are displayed as reference.
